...
initsFunction = function() {list(Beta_ShoreHab=Beta_ShoreHab,Beta_FEDR=Beta_FEDR,Beta_TS=Beta_TS, 
...
params<-c("Beta_ShoreHab","Beta_TS","Beta_FEDR",
...
writeLines("
           ...
           log(lambda[i]) <- alpha.lam + Beta_FEDR[FEDR[i]] + Beta_ShoreHab[SH[i]] + Beta_TS * TS[i] + eps[i]
           ...
           ", con = here("Shorebird_aquaculture_project","REKN_Models", "ZIP_DistShorelineandTotShorebirdsModel.txt"))

#Identify filepath of model file;
modfile <- here("Shorebird_aquaculture_project","REKN_Models", "ZIP_DistShorelineandTotShorebirdsModel.txt")
...
sink(file=here("Shorebird_aquaculture_project","OutputFiles","REKN","outputDistShorelineandTotShorebirdsModel.txt"))
