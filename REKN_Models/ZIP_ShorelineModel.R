...
initsFunction = function() {list(Beta_ShoreHab=Beta_ShoreHab,
...
writeLines("
           ...
           log(lambda[i]) <- alpha.lam + Beta_ShoreHab[SH[i]] +eps[i]
           ...
           ", con = here("Shorebird_aquaculture_project","REKN_Models", "ZIP_ShorelineModel.txt"))

#Identify filepath of model file;
modfile <- here("Shorebird_aquaculture_project","REKN_Models", "ZIP_ShorelineModel.txt")
...
sink(file=here("Shorebird_aquaculture_project","OutputFiles","REKN","outputShorelineModel.txt"))
