...
initsFunction = function() {list(Beta_windS=Beta_windS,Beta_TS=Beta_TS,Beta_Activity=Beta_Activity,
...
params<-c("Beta_windS","Beta_TS","Beta_Activity",
...
writeLines("
           ...
           log(lambda[i]) <- alpha.lam + Beta_windS*windS[i] +Beta_TS*TS[i] + Beta_Activity * activities[i] + eps[i]
           ...
           ", con = here("Shorebird_aquaculture_project","REKN_Models", "ZIP_windSShorebirdsActivitiesModel.txt"))

#Identify filepath of model file;
modfile <- here("Shorebird_aquaculture_project","REKN_Models", "ZIP_windSShorebirdsActivitiesModel.txt")
...
sink(file=here("Shorebird_aquaculture_project","OutputFiles","REKN","outputwindSShorebirdsActivitiesModel.txt"))
