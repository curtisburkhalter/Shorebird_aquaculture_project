...
initsFunction = function() {list(Beta_nGulls=Beta_nGulls,Beta_TS=Beta_TS,
...
writeLines("
           ...
           ", con = here("Shorebird_aquaculture_project","REKN_Models", "ZIP_nGullsandShorebirdsModel.txt"))

#Identify filepath of model file;
modfile <- here("Shorebird_aquaculture_project","REKN_Models", "ZIP_nGullsandShorebirdsModel.txt")
...
sink(file=here("Shorebird_aquaculture_project","OutputFiles","REKN","outputnGullsandShorebirdsModel.txt"))
out
sink()
