...
initsFunction = function() {list(Beta_nGulls=Beta_nGulls,Beta_TS=Beta_TS,Beta_Activity=Beta_Activity,Beta_plane=Beta_plane,
...
params<-c("Beta_nGulls","Beta_TS","Beta_Activity","Beta_plane",
...
writeLines("
           ...
           log(lambda[i]) <- alpha.lam + Beta_nGulls*nGulls[i] +Beta_TS*TS[i] + Beta_Activity * activities[i] + Beta_plane * plane[i] + eps[i]
           ...
           ", con = here("Shorebird_aquaculture_project","REKN_Models", "ZIP_GullsShorebirdsActivitiesPlanesModel.txt"))

#Identify filepath of model file;
modfile <- here("Shorebird_aquaculture_project","REKN_Models", "ZIP_GullsShorebirdsActivitiesPlanesModel.txt")
...
sink(file=here("Shorebird_aquaculture_project","OutputFiles","REKN","outputGullsShorebirdsActivitiesPlanesModel.txt"))
