...
writeLines("
           ...
           log(lambda[i]) <- alpha.lam + Beta_plane*plane[i] +eps[i]
           ...
           ", con = here("Shorebird_aquaculture_project","REKN_Models", "ZIP_PlaneModel.txt"))

#Identify filepath of model file;
modfile <- here("Shorebird_aquaculture_project","REKN_Models", "ZIP_PlaneModel.txt")
...
sink(file=here("Shorebird_aquaculture_project","OutputFiles","REKN","outputPlaneModel.txt"))
