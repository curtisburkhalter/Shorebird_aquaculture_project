...
writeLines("
           ...
           logit(p.occ[i]) <- alpha.lam + Beta_day*day[i] +eps[i]
           ...
           ", con = here("Shorebird_aquaculture_project","REKN_Models", "LogRegression_DayModel.txt"))

#Identify filepath of model file;
modfile <- here("Shorebird_aquaculture_project","REKN_Models", "LogRegression_DayModel.txt")
...
sink(file=here("Shorebird_aquaculture_project","OutputFiles","REKN","outputLogRegression_DayModel.txt"))
