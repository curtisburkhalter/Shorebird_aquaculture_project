...
writeLines("
           ...
           logit(p.occ[i]) <- alpha.lam + Beta_nGulls*nGulls[i] +eps[i]
           ...
           ", con = here("Shorebird_aquaculture_project","REKN_Models", "LogRegression_nGullsModel.txt"))

#Identify filepath of model file;
modfile <- here("Shorebird_aquaculture_project","REKN_Models", "LogRegression_nGullsModel.txt")
...
sink(file=here("Shorebird_aquaculture_project","OutputFiles","REKN","outputLogRegression_nGullsModel.txt"))
