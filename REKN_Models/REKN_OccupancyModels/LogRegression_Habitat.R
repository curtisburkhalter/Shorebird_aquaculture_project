...
writeLines("
           ...
           logit(p.occ[i]) <- alpha.lam + Beta_habitat[habitat[i]] +eps[i]
           ...
           ", con = here("Shorebird_aquaculture_project","REKN_Models", "LogRegression_HabitatModel.txt"))

#Identify filepath of model file;
modfile <- here("Shorebird_aquaculture_project","REKN_Models", "LogRegression_HabitatModel.txt")
...
sink(file=here("Shorebird_aquaculture_project","OutputFiles","REKN","outputLogRegression_HabitatModel.txt"))
