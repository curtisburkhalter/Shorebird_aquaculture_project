...
initsFunction = function() {list(Beta_tending=Beta_tending,Beta_DistfromAQ=Beta_DistfromAQ,
...
params<-c("Beta_tending","Beta_DistfromAQ",
...
writeLines("
           ...
           logit(p.occ[i]) <- alpha.lam + Beta_tending[tending[i]] + Beta_DistfromAQ*dist_from_AQ[i] + seg_rand[segment[i]] + year_rand[year[i]]
           ...
           ", con = here("Shorebird_aquaculture_project","REKN_Models", "REKN_OccupancyModels", "LogRegression_TendingDistfromAQRandomSegmentandYearModel.txt"))

#Identify filepath of model file;
modfile <- here("Shorebird_aquaculture_project","REKN_Models", "REKN_OccupancyModels", "LogRegression_TendingDistfromAQRandomSegmentandYearModel.txt")
...
sink(file=here("Shorebird_aquaculture_project","OutputFiles","REKN","outputLogRegression_TendingDistfromAQ_RandomSegmentandYearModel.txt"))
