...
writeLines("
           ...
           ", con = here("Shorebird_aquaculture_project","REKN_Models", "REKN_OccupancyModels", "LogRegression_ShorelineRandomSegmentandYearModel.txt"))

#Identify filepath of model file;
modfile <- here("Shorebird_aquaculture_project","REKN_Models", "REKN_OccupancyModels", "LogRegression_ShorelineRandomSegmentandYearModel.txt")
...
sink(file=here("Shorebird_aquaculture_project","OutputFiles","REKN","outputLogRegression_Shoreline_RandomSegmentandYearModel.txt"))
