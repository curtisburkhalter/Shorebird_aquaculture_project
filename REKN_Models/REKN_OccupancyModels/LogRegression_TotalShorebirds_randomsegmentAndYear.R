...
writeLines("
          ...
          # y year random effect
           ...
           ", con = here("Shorebird_aquaculture_project","REKN_Models", "LogRegression_TotShorebirdsRandomSegmentandYearModel.txt"))

#Identify filepath of model file;
modfile <- here("Shorebird_aquaculture_project","REKN_Models", "LogRegression_TotShorebirdsRandomSegmentandYearModel.txt")
...
sink(file=here("Shorebird_aquaculture_project","OutputFiles","REKN","outputLogRegression_TotShorebirds_RandomSegmentandYearModel.txt"))
