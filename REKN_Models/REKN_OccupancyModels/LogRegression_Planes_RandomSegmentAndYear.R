...
writeLines("
           ...
           ", con = here("Shorebird_aquaculture_project","REKN_Models", "REKN_OccupancyModels", "LogRegression_PlaneRandomSegmentandYearModel.txt"))

#Identify filepath of model file;
modfile <- here("Shorebird_aquaculture_project","REKN_Models", "REKN_OccupancyModels", "LogRegression_PlaneRandomSegmentandYearModel.txt")
...
sink(file=here("Shorebird_aquaculture_project","OutputFiles","REKN","outputLogRegression_Plane_RandomSegmentandYearModel.txt"))
