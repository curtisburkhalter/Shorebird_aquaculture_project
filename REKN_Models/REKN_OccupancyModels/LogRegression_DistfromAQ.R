...
writeLines("
           ...
           ", con = here("Shorebird_aquaculture_project","REKN_Models", "LogRegression_DistfromAQModel.txt"))

#Identify filepath of model file;
modfile <- here("Shorebird_aquaculture_project","REKN_Models", "LogRegression_DistfromAQModel.txt")
...
sink(file=here("Shorebird_aquaculture_project","OutputFiles","REKN","outputLogRegression_DistfromAQModel.txt"))
