...
writeLines("
           ...
           ", con = here("Shorebird_aquaculture_project","REKN_Models", "REKN_OccupancyModels", "LogRegression_TendingandnGullsRandomSegmentandYearModel.txt"))

#Identify filepath of model file;
modfile <- here("Shorebird_aquaculture_project","REKN_Models", "REKN_OccupancyModels", "LogRegression_TendingandnGullsRandomSegmentandYearModel.txt")
...
sink(file=here("Shorebird_aquaculture_project","OutputFiles","REKN","outputLogRegression_TendingandnGulls_RandomSegmentandYearModel.txt"))
