...
initsFunction = function() {list(Beta_FEDR=Beta_FEDR,Beta_tending=Beta_tending,
...
params<-c("Beta_FEDR","Beta_tending",
...
writeLines("
           ...
           log(lambda[i]) <- alpha.lam + Beta_FEDR[FEDR[i]] + Beta_tending[tending[i]] + eps[i]
           ...
           ", con = here("Shorebird_aquaculture_project","REKN_Models", "ZIP_DistandTendingModel.txt"))

#Identify filepath of model file;
modfile <- here("Shorebird_aquaculture_project","REKN_Models", "ZIP_DistandTendingModel.txt")
...
sink(file=here("Shorebird_aquaculture_project","OutputFiles","REKN","outputDistandTendingModel.txt"))
