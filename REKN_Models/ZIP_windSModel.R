...
initsFunction = function() {list(Beta_windS=Beta_windS,
...
writeLines("
           ...
           log(lambda[i]) <- alpha.lam + Beta_windS*windS[i] +eps[i]
           ...
           ", con = here("Shorebird_aquaculture_project","REKN_Models", "ZIP_windSModel.txt"))

#Identify filepath of model file;
modfile <- here("Shorebird_aquaculture_project","REKN_Models", "ZIP_windSModel.txt")
...
sink(file=here("Shorebird_aquaculture_project","OutputFiles","REKN","outputwindSModel.txt"))
out
sink()
