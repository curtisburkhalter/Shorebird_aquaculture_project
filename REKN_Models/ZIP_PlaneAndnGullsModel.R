...
initsFunction = function() {list(Beta_plane=Beta_plane,Beta_nGulls=Beta_nGulls,
...
params<-c("Beta_plane","Beta_nGulls",
...
writeLines("
           ...
           log(lambda[i]) <- alpha.lam + Beta_plane*plane[i] + Beta_nGulls * nGulls[i] +eps[i]
           ...
           ", con = here("Shorebird_aquaculture_project","REKN_Models", "ZIP_PlaneandGullsModel.txt"))

#Identify filepath of model file;
modfile <- here("Shorebird_aquaculture_project","REKN_Models", "ZIP_PlaneAndGullsModel.txt")
...
sink(file=here("Shorebird_aquaculture_project","OutputFiles","REKN","outputPlaneandGullsModel.txt"))
