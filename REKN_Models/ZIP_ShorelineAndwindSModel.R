...
params<-c("Beta_ShoreHab","Beta_windS",
...
writeLines("
           ...
           ", con = here("Shorebird_aquaculture_project","REKN_Models", "ZIP_ShorelineandWindModel.txt"))

#Identify filepath of model file;
modfile <- here("Shorebird_aquaculture_project","REKN_Models", "ZIP_ShorelineandWindModel.txt")
...
sink(file=here("Shorebird_aquaculture_project","OutputFiles","REKN","outputShorelineandWindModel.txt"))
