...
initsFunction = function() {list(Beta_windS=Beta_windS,Beta_TS=Beta_TS,Beta_planes=Beta_planes,
...
params<-c("Beta_windS","Beta_TS","Beta_planes",
...
writeLines("
           ...
           log(lambda[i]) <- alpha.lam + Beta_windS*windS[i] +Beta_TS*TS[i] + Beta_planes*plane[i] + eps[i]
           ...
           ", con = here("Shorebird_aquaculture_project","REKN_Models", "ZIP_windSShorebirdsPlanesModel.txt"))

#Identify filepath of model file;
modfile <- here("Shorebird_aquaculture_project","REKN_Models", "ZIP_windSShorebirdsPlanesModel.txt")
...
sink(file=here("Shorebird_aquaculture_project","OutputFiles","REKN","outputwindSShorebirdsPlanesModel.txt"))
