...
writeLines("
           ...
           log(lambda[i]) <- alpha.lam + Beta_nGulls*nGulls[i] +eps[i]
           ...
           ", con = here("Shorebird_aquaculture_project","REKN_Models", "ZIP_nGullsModel.txt"))

#Identify filepath of model file;
modfile <- here("Shorebird_aquaculture_project","REKN_Models", "ZIP_nGullsModel.txt")
...
sink(file=here("Shorebird_aquaculture_project","OutputFiles","REKN","outputnGullsModel.txt"))
out
sink()
