...
Beta_tending=as.integer(c(NA,1))
Beta_planes=1
Beta_windS=1
alpha.lam=1
omega=1
...
initsFunction = function() {list(Beta_FEDR=Beta_FEDR,Beta_tending=Beta_tending,Beta_planes=Beta_planes,Beta_windS=Beta_windS,
...
params<-c("Beta_FEDR","Beta_tending","Beta_planes","Beta_windS",
...
writeLines("
           ...
           ", con = here("Shorebird_aquaculture_project","REKN_Models", "ZIP_DistTendingWindandPlanesModelModel.txt"))

#Identify filepath of model file;
modfile <- here("Shorebird_aquaculture_project","REKN_Models", "ZIP_DistTendingWindandPlanesModelModel.txt")
...
sink(file=here("Shorebird_aquaculture_project","OutputFiles","REKN","outputDistTendingWindandPlanesModel.txt"))
