...
writeLines("
           ...
           ", con = here("Shorebird_aquaculture_project","RUTU_Models", "LogRegression_HabitatRandomSegmentandYearModel.txt"))

#Identify filepath of model file;
modfile <- here("Shorebird_aquaculture_project","RUTU_Models", "LogRegression_HabitatRandomSegmentandYearModel.txt")
...
sink(file=here("Shorebird_aquaculture_project","OutputFiles","RUTU","outputLogRegression_Habitat_RandomSegmentandYearModel.txt"))
