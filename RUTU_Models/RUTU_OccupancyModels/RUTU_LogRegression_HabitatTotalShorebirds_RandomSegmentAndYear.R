...
writeLines("
           ...
           ", con = here("Shorebird_aquaculture_project","RUTU_Models", "LogRegression_HabitatTotalShorebirdsRandomSegmentandYearModel.txt"))

#Identify filepath of model file;
modfile <- here("Shorebird_aquaculture_project","RUTU_Models", "LogRegression_HabitatTotalShorebirdsRandomSegmentandYearModel.txt")
...
sink(file=here("Shorebird_aquaculture_project","OutputFiles","RUTU","outputLogRegression_HabitatTotalShorebirds_RandomSegmentandYearModel.txt"))
