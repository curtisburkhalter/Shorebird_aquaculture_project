...
writeLines("
           ...
           ", con = here("Shorebird_aquaculture_project","RUTU_Models", "RUTU_OccupancyModels", "LogRegression_ShorelineRandomSegmentandYearModel.txt"))

#Identify filepath of model file;
modfile <- here("Shorebird_aquaculture_project","RUTU_Models", "RUTU_OccupancyModels", "LogRegression_ShorelineRandomSegmentandYearModel.txt")
...
sink(file=here("Shorebird_aquaculture_project","OutputFiles","RUTU","outputLogRegression_Shoreline_RandomSegmentandYearModel.txt"))
