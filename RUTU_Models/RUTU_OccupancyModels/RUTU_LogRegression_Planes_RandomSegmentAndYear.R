...
writeLines("
           ...
           ", con = here("Shorebird_aquaculture_project","RUTU_Models", "RUTU_OccupancyModels", "LogRegression_PlaneRandomSegmentandYearModel.txt"))

#Identify filepath of model file;
modfile <- here("Shorebird_aquaculture_project","RUTU_Models", "RUTU_OccupancyModels", "LogRegression_PlaneRandomSegmentandYearModel.txt")
...
sink(file=here("Shorebird_aquaculture_project","OutputFiles","RUTU","outputLogRegression_Plane_RandomSegmentandYearModel.txt"))
