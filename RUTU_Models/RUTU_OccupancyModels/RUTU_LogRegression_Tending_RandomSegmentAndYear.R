...
writeLines("
          ...
          # y year random effect
           ...
           ", con = here("Shorebird_aquaculture_project","RUTU_Models","RUTU_OccupancyModels", "LogRegression_TendingRandomSegmentandYearModel.txt"))

#Identify filepath of model file;
modfile <- here("Shorebird_aquaculture_project","RUTU_Models", "RUTU_OccupancyModels", "LogRegression_TendingRandomSegmentandYearModel.txt")
...
sink(file=here("Shorebird_aquaculture_project","OutputFiles","RUTU","outputLogRegression_Tending_RandomSegmentandYearModel.txt"))
