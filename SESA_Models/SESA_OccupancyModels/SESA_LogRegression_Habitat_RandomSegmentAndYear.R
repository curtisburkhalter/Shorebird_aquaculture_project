...
initsFunction = function() {list(Beta_habitat=Beta_habitat,
...
writeLines("
           ...
           logit(p.occ[i]) <- alpha.lam + Beta_habitat[habitat[i]] + seg_rand[segment[i]] + year_rand[year[i]]
           ...
           ", con = here("Shorebird_aquaculture_project","SESA_Models", "LogRegression_HabitatRandomSegmentandYearModel.txt"))

#Identify filepath of model file;
modfile <- here("Shorebird_aquaculture_project","SESA_Models", "LogRegression_HabitatRandomSegmentandYearModel.txt")
...
sink(file=here("Shorebird_aquaculture_project","OutputFiles","SESA","outputLogRegression_Habitat_RandomSegmentandYearModel.txt"))
