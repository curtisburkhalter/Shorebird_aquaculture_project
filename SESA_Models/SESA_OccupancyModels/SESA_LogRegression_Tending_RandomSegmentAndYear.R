...
writeLines("
          ...
          # y year random effect
           ...
           ", con = here("Shorebird_aquaculture_project","SESA_Models","SESA_OccupancyModels", "LogRegression_TendingRandomSegmentandYearModel.txt"))

#Identify filepath of model file;
modfile <- here("Shorebird_aquaculture_project","SESA_Models", "SESA_OccupancyModels", "LogRegression_TendingRandomSegmentandYearModel.txt")
...
sink(file=here("Shorebird_aquaculture_project","OutputFiles","SESA","outputLogRegression_Tending_RandomSegmentandYearModel.txt"))
