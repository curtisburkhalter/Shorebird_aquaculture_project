...
initsFunction = function() {list(Beta_nGulls=Beta_nGulls,
...
writeLines("
          ...
          # y year random effect
           ...
           logit(p.occ[i]) <- alpha.lam + Beta_nGulls*nGulls[i] + seg_rand[segment[i]] + year_rand[year[i]]
           ...
           ", con = here("Shorebird_aquaculture_project","SESA_Models","SESA_OccupancyModels", "LogRegression_nGullsRandomSegmentandYearModel.txt"))

#Identify filepath of model file;
modfile <- here("Shorebird_aquaculture_project","SESA_Models", "SESA_OccupancyModels", "LogRegression_nGullsRandomSegmentandYearModel.txt")
...
sink(file=here("Shorebird_aquaculture_project","OutputFiles","SESA","outputLogRegression_nGulls_RandomSegmentandYearModel.txt"))
