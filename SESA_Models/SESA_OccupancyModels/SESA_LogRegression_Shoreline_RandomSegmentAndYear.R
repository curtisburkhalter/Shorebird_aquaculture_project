...
writeLines("
           ...
           logit(p.occ[i]) <- alpha.lam + Beta_NSH[NSH[i]] + seg_rand[segment[i]] + year_rand[year[i]]
           ...
           ", con = here("Shorebird_aquaculture_project","SESA_Models", "SESA_OccupancyModels", "LogRegression_ShorelineRandomSegmentandYearModel.txt"))

#Identify filepath of model file;
modfile <- here("Shorebird_aquaculture_project","SESA_Models", "SESA_OccupancyModels", "LogRegression_ShorelineRandomSegmentandYearModel.txt")
...
sink(file=here("Shorebird_aquaculture_project","OutputFiles","SESA","outputLogRegression_Shoreline_RandomSegmentandYearModel.txt"))
