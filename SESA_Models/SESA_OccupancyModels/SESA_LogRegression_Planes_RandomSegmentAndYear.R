...
writeLines("
           ...
           ", con = here("Shorebird_aquaculture_project","SESA_Models", "SESA_OccupancyModels", "LogRegression_PlaneRandomSegmentandYearModel.txt"))

#Identify filepath of model file;
modfile <- here("Shorebird_aquaculture_project","SESA_Models", "SESA_OccupancyModels", "LogRegression_PlaneRandomSegmentandYearModel.txt")
...
sink(file=here("Shorebird_aquaculture_project","OutputFiles","SESA","outputLogRegression_Plane_RandomSegmentandYearModel.txt"))
