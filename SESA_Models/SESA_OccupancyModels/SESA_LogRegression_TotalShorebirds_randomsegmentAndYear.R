...
writeLines("
          ...
          # y year random effect
           ...
           logit(p.occ[i]) <- alpha.lam + Beta_TS*TS[i] + seg_rand[segment[i]] + year_rand[year[i]]
           ...
           ", con = here("Shorebird_aquaculture_project","SESA_Models", "LogRegression_TotShorebirdsRandomSegmentandYearModel.txt"))

#Identify filepath of model file;
modfile <- here("Shorebird_aquaculture_project","SESA_Models", "LogRegression_TotShorebirdsRandomSegmentandYearModel.txt")
...
sink(file=here("Shorebird_aquaculture_project","OutputFiles","SESA","outputLogRegression_TotShorebirds_RandomSegmentandYearModel.txt"))
