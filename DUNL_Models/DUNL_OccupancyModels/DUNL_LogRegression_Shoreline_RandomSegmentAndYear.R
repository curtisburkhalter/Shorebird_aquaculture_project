...
writeLines("
           ...
           ", con = here("Shorebird_aquaculture_project","DUNL_Models", "DUNL_OccupancyModels", "LogRegression_ShorelineRandomSegmentandYearModel.txt"))

#Identify filepath of model file;
modfile <- here("Shorebird_aquaculture_project","DUNL_Models", "DUNL_OccupancyModels", "LogRegression_ShorelineRandomSegmentandYearModel.txt")
...
sink(file=here("Shorebird_aquaculture_project","OutputFiles","DUNL","outputLogRegression_Shoreline_RandomSegmentandYearModel.txt"))
