...
writeLines("
           ...
           ", con = here("Shorebird_aquaculture_project","DUNL_Models", "DUNL_OccupancyModels", "LogRegression_TendingandTotShorebirdsRandomSegmentandYearModel.txt"))

#Identify filepath of model file;
modfile <- here("Shorebird_aquaculture_project","DUNL_Models", "DUNL_OccupancyModels", "LogRegression_TendingandTotShorebirdsRandomSegmentandYearModel.txt")
...
sink(file=here("Shorebird_aquaculture_project","OutputFiles","DUNL","outputLogRegression_TendingandTotShorebirds_RandomSegmentandYearModel.txt"))
