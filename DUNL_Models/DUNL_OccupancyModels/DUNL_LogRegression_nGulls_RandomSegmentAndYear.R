...
writeLines("
          ...
          # y year random effect
           ...
           ", con = here("Shorebird_aquaculture_project","DUNL_Models","DUNL_OccupancyModels", "LogRegression_nGullsRandomSegmentandYearModel.txt"))

#Identify filepath of model file;
modfile <- here("Shorebird_aquaculture_project","DUNL_Models", "DUNL_OccupancyModels", "LogRegression_nGullsRandomSegmentandYearModel.txt")
...
sink(file=here("Shorebird_aquaculture_project","OutputFiles","DUNL","outputLogRegression_nGulls_RandomSegmentandYearModel.txt"))
