...
writeLines("
           ...
           ", con = here("Shorebird_aquaculture_project","SAND_Models", "SAND_OccupancyModels", "LogRegression_DistfromAQRandomSegmentandYearModel.txt"))

#Identify filepath of model file;
modfile <- here("Shorebird_aquaculture_project","SAND_Models", "SAND_OccupancyModels", "LogRegression_DistfromAQRandomSegmentandYearModel.txt")
...
sink(file=here("Shorebird_aquaculture_project","OutputFiles","SAND","outputLogRegression_DistfromAQ_RandomSegmentandYearModel.txt"))
