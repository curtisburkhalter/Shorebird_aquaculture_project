...
writeLines("
          ...
          # y year random effect
           ...
           ", con = here("Shorebird_aquaculture_project","SAND_Models","SAND_OccupancyModels", "LogRegression_DayRandomSegmentandYearModel.txt"))

#Identify filepath of model file;
modfile <- here("Shorebird_aquaculture_project","SAND_Models", "SAND_OccupancyModels", "LogRegression_DayRandomSegmentandYearModel.txt")
...
sink(file=here("Shorebird_aquaculture_project","OutputFiles","SAND","outputLogRegression_Day_RandomSegmentandYearModel.txt"))
