...
writeLines("
          ...
          # y year random effect
           ...
           ", con = here("Shorebird_aquaculture_project","SAND_Models","SAND_OccupancyModels","LogRegression_TotShorebirdsRandomSegmentandYearModel.txt"))

#Identify filepath of model file;
modfile <- here("Shorebird_aquaculture_project","SAND_Models","SAND_OccupancyModels", "LogRegression_TotShorebirdsRandomSegmentandYearModel.txt")
...
sink(file=here("Shorebird_aquaculture_project","OutputFiles","SAND","outputLogRegression_TotShorebirds_RandomSegmentandYearModel.txt"))
